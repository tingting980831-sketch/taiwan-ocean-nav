...
def astar(start, goal, u, v, land_mask, safety):
    ...
    while pq:
        ...
        for d in directions:
            ...
            flow = u[current] * d[1] + v[current] * d[0]

            land_penalty = 1/(safety[ni,nj] + 1)

            new_cost = cost_so_far[current] + dist + land_penalty - 0.5*flow
...
def plot_map(lons, lats, u, v, path):
    ...
    plt.title("Ocean Current Navigation Route")
